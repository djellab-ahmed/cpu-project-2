...
void ggml_compute_forward_qkv_mv_rope(const struct ggml_compute_params * params, struct ggml_tensor * dst);
...
void ggml_compute_forward_flash_attn_decode_cpu(const struct ggml_compute_params * params, struct ggml_tensor * dst);
